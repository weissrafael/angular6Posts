...
export class PostListComponent implements OnInit {
  ...
  usersPhones = [];
  slidePanel = false;
  editingThisPost =   { id: 0, message: '', date: '', beingEdited: false, userPopUp: false,  user: {}};
  creatingThisPost =   { id: 0, message: '', date: '', beingEdited: false, userPopUp: false,  user: {}};
  ...
  openUserPopUp(post): void {
    post.userPopUp = true;
    setTimeout(() => { this.slidePanel = true; }, 500);
  }
  ...
  closeUserPopUp(post): void {
    ...
    this.clock = setTimeout(() => { post.userPopUp = false; }, 500);
